...
def _normalize_cheatkey_params(params: Dict[str, Any]) -> Dict[str, Any]:
    cheatkey_param_names = {
        ...
        "cheatkey_lookback",
        "cheatkey_timefilter",
        "cheatkey_timefilter_minutes",
        "cheatkey_diff_lookback",
        "slowcheat",
        "slowcheat_fast_ema",
        "slowcheat_slow_ema",
        "slowcheat_lookafter",
        "slowcheat_timefilter",
        "slowcheat_timefilter_minutes",
        "diff_lookback_n",
        "slope_exit_mode",
        "slope_exit",
        "slope_exit_lookback",
        ...
        "move_sl_peak_drawdown_trigger_pnl",
        "move_sl_peak_drawdown_exit_pnl",
        "move_tp_on_loss",
        "move_tp_trigger_pnl",
        "move_tp_target_pnl",
        "use_rr_tp_from_sl_pnl",
        "rr_tp_from_sl_multiplier",
        "auto_leverage_min_loss_pnl",
        "auto_leverage_max_loss_pnl",
        "auto_leverage_max_leverage",
        "use_auto_leverage_min_loss_multiplier",
        "auto_leverage_min_loss_multiplier",
        "use_auto_leverage_sl_multiplier",
        "auto_leverage_sl_min_pct",
        "auto_leverage_sl_max_pct",
        "auto_leverage_sl_min_multiplier",
        "auto_leverage_sl_max_multiplier",
